...
// Vérifie bien le chemin et le nom du fichier (scheduler.store)
import { useSchedulerStore } from "@/src/features/scheduler/store/schedule.store"; 

export default function ScheduleList() {
  // On récupère les états du store
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-2">
                  ...
                  {/* On vérifie si audio_track_id existe dans l'objet */}
                  {item.audio_track_id && (
