...
import { useTvVisibilityStore } from "@/src/projects/client-dashboard/display/stores/tv-visibility.store";
...
export default function DisplayContent() {
  const { toggleTvVisibility, toggleCategoryVisibility, loadingId } = useTvVisibilityStore();
