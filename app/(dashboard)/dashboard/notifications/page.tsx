...
export default function GlobalNotificationsPage() {
  ...
  const text = locale === "ar"
    ? {
        ...
        subtitle: "تابع التنبيهات التشغيلية والتنبيهات المهمة في عرض منظم وواضح.",
        live: "التدفق المباشر",
    ...
    : {
        ...
        subtitle: "Suivez les notifications critiques et operationnelles dans une presentation plus lisible.",
        live: "Flux live",
  ...
  return (
    <div dir={isRtl ? "rtl" : "ltr"} className="space-y-6 md:space-y-8">
      ...
      <NotificationsCenter tenantId={null} backHref="/dashboard" />
    </div>
  );
}
