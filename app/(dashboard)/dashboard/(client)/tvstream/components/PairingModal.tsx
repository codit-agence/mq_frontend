...
export const PairingModal = ({ code, setCode, onConfirm, onCancel, isSubmitting }: Props) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-[#020617]/90 backdrop-blur-sm">
    ...
    >
      ...
      <h2 className="text-3xl font-black mb-4 text-white">Vérification Sécurité</h2>
      <p className="text-slate-400 mb-8">
        Entrez les 4 chiffres qui s'affichent sur votre écran TV maintenant.
      </p>
      ...
      <div className="flex gap-4">
        ...
        >
          {isSubmitting ? <Loader2 className="animate-spin" /> : "CONFIRMER LA LIAISON"}
        </button>
      </div>
    </motion.div>
  </div>
